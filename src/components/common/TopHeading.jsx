...
const TopHeading = ({ heading }) => {
  ...
  return (
    <div className="relative w-full  pt-40 pb-72  bg-cover bg-center -mt-24  leading-loose">
      ...
      <hr className="border-x-0   border-gray-500  relative mx-20  mb-10 -mt-8" />
      <h1 className="relative z-20 flex justify-center items-center font-bold text-5xl md:text-6xl  text-center px-10 text-transparent bg-clip-text bg-gradient-to-t from-blue-200 to-white pb-5 font-poppins">
        {heading}
      </h1>
